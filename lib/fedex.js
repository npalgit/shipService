...
fedex.prototype.getRates = function (req,callback){
    var strVar = "";
    ...
    strVar += "					<\/Contact>";
    strVar += "					<Address>";
    strVar += "						<StreetLines>"+req.fromaddress.address1+"<\/StreetLines>";
    strVar += "						<StreetLines>"+req.fromaddress.address2+"<\/StreetLines>";
    strVar += "						<City>"+req.fromaddress.city+"<\/City>";
    strVar += "						<StateOrProvinceCode>"+req.fromaddress.state+"<\/StateOrProvinceCode>";
    strVar += "						<PostalCode>"+req.fromaddress.zip+"<\/PostalCode>";
    strVar += "						<CountryCode>"+req.fromaddress.country+"<\/CountryCode>";
    strVar += "					<\/Address>";
    strVar += "				<\/Shipper>";
    strVar += "				<Recipient>";
    strVar += "					<Contact>";
    ...
    strVar += "					<\/Contact>";
    strVar += "					<Address>";
    strVar += "						<StreetLines>"+req.toaddress.address1+"<\/StreetLines>";
    strVar += "						<City>"+req.toaddress.city+"<\/City>";
    strVar += "						<StateOrProvinceCode>"+req.toaddress.state+"<\/StateOrProvinceCode>";
    strVar += "						<PostalCode>"+req.toaddress.zip+"<\/PostalCode>";
    strVar += "						<CountryCode>"+req.toaddress.country+"<\/CountryCode>";
    strVar += "					<\/Address>";
    strVar += "				<\/Recipient>";
